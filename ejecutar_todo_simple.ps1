# Script maestro para ejecutar todo automaticamente
...
try {
    ...
    # Ejecutar configuracion automatica
    ...
    if ($response -eq "1") {
        ...
        Write-Host "5. Ejecuta este script nuevamente: .\ejecutar_todo_simple.ps1" -ForegroundColor Cyan
    }
}
